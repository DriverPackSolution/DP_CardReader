                             README.TXT File
     README file for OMNIKEY CardMan 8630 PC/SC Driver, Version 1.0.2.2
                    (C) Copyright OMNIKEY AG, 2002

This document describes the release notes of the CardMan 8630 PC/SC Driver
==========================================================================
...
To install the CardMan 8630 PC/SC Interface Device Handler run 'setup.exe'
on disk1 and follow the instructions in the setup program.

Make sure that you reboot the system before using the CardMan 8630.
...
1. Connect your CardMan 8630 to a free serial port and to the front of the
...
to uninstall the PC/SC IFD handler for CardMan 8630.
...
The CardMan 8630 needs the Microsoft Smartcard Base Components for proper
operation.
...
You can uninstall the PC/SC driver for CardMan 8630 by using the
...
It is only loaded if a CardMan 8630 is connected.
