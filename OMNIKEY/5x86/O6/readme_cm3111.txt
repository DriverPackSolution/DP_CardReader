                             ...
                             README.TXT File
    README file for OMNIKEY CardMan 3111, Version 1.1.2.1
               Copyright (c) 2000 - 2007 OMNIKEY

This document describes the release notes of the OMNIKEY CardMan 3111 Driver
=================================================================================
...
Plug the OMNIKEY CardMan 3111 into a free serial port.
...
The OMNIKEY CardMan 3111 needs the Microsoft Smartcard Base Components for proper 
operation.
...
Then click on the 'CardMan 3111' entry with the right mouse button and click on 
...
Click on 'Start' --> 'Control Panel', doubleclick on the Systemicon, the 'System 
...
IV. FCC Information:
********************
CardMan 3111 is certified according to the FCC standard. The user must not modify 
