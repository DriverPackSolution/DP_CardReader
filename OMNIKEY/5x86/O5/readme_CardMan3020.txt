                             ...
                             README.TXT File
   README file for OMNIKEY CardMan 3020 PC/SC Driver, Version 1.0.3.0
                    (C) Copyright OMNIKEY AG,2001 - 2002

This document describes the release notes of the OMNIKEY CardMan 3020 Driver
============================================================================
...
Card Interfaces:
----------------
The CardMan 3020 is able to use the PC/SC and the EMV Card Interface.
