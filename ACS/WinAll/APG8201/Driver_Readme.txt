...
--------
   ...
   4. New Installation
      ...
      4.3. New Installation (Windows XP    & Server 2003)
      4.4. New Installation (Windows Vista & Server 2008)
      4.5. New Installation (Windows 7     & Server 2008 R2)
   5. Driver Update    
      5.1. Driver Update    (Windows 98/Me)
      5.2. Driver Update    (Windows 2000)
      5.3. Driver Update    (Windows XP    & Server 2003)
      5.4. Driver Update    (Windows Vista & Server 2008)
      5.5. Driver Update    (Windows 7     & Server 2008 R2)
...
----------------
   ...
   a8201w98.sys		1.1.6.9
   apg8201.cat		x.x.x.x
   apg8201.inf		x.x.x.x
   apg8201.sys		1.1.6.9
   apg8201x64.sys	1.1.6.9
   Release.txt  
